...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $jenis_kas = 'Jumat'; // HARDCODED untuk kas jumat
...
$query_saldo = mysqli_query($conn, "
    ...
    FROM kas_masjid WHERE jenis_kas = 'Jumat'
");
...
<head>
    ...
    <title>Input Kas Jumat - Website Masjid</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <div class="container mt-5 mb-5 pb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="text-primary fw-bold" style="font-family: var(--bs-body-font-family)"><i class="fas fa-hand-holding-usd text-primary me-2"></i>Kas Jum'at</h2>
                <p class="text-muted">Pencatatan Pemasukan dan Pengeluaran khusus hari Jum'at</p>
            </div>
            <div>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalKas">
                    <i class="fas fa-plus me-1"></i> Tambah Transaksi Jum'at
                </button>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <div class="card bg-danger text-white shadow">
                    <div class="card-body">
                        <h5>Total Pengeluaran Jum'at</h5>
            ...
            <div class="card-body table-responsive">
                <table id="tabelKas" class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $query = mysqli_query($conn, "SELECT * FROM kas_masjid WHERE jenis_kas = 'Jumat' ORDER BY tanggal DESC, id_kas DESC");
            ...
            <div class="modal-content">
                <form method="POST">
                    ...
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="modalTitle">Tambah Transaksi Jum'at</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" id="keterangan" class="form-control" rows="3" required placeholder="Contoh: Infak Kotak Keliling, Kotak Besar..."></textarea>
                        </div>
                    </div>
    ...
    <script>
        ...
        function editKas(data) {
            ...
            document.getElementById('modalTitle').innerText = 'Edit Transaksi Jum\'at';
        ...
        document.getElementById('modalKas').addEventListener('hidden.bs.modal', function () {
            ...
            document.getElementById('modalTitle').innerText = 'Tambah Transaksi Jum\'at';
        });
    </script>
</body>
</html>
